...
! CHECK:         %[[VAL_17:.*]] = select %[[VAL_16]], %[[VAL_15]], %[[VAL_14]] : i64
...
! CHECK:         %[[VAL_14:.*]] = select %[[VAL_13]], %[[VAL_12]], %[[VAL_9]] : index
...
! CHECK:           %[[VAL_40:.*]] = select %[[VAL_39]], %[[VAL_38]], %[[VAL_37]] : index
...
! CHECK:           %[[VAL_57:.*]] = select %[[VAL_56]], %[[VAL_40]], %[[VAL_19]] : index
...
! CHECK:           %[[VAL_46:.*]] = select %[[VAL_45]], %[[VAL_29]], %[[VAL_8]] : index
...
! CHECK:           %[[VAL_49:.*]] = select %[[VAL_48]], %[[VAL_47]], %[[VAL_46]] : index
...
! CHECK:           %[[VAL_66:.*]] = select %[[VAL_65]], %[[VAL_49]], %[[VAL_34]] : index
